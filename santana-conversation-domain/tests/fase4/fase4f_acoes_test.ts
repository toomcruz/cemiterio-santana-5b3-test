...
import { assertEquals, assert } from "../../../tests/fixtures/assert.ts";
...
Deno.test("4F: acompanhamento tem ciclo próprio e não colapsa", () => {
  const acomp = { id: "c1", acao_id: "a1", estado: "ABERTO", criado_em: "2026-01-01T00:00:00Z", ultima_atualizacao: "2026-01-01T00:00:00Z", ciclo_proprio: 0 };
