...
begin
 ...
 insert into support_vnext_test.complaint_proposal_fixture_context (test_run_id,release_id,intent_id,service_id,template_id,request_policy_id,conversation_id,session_id,topic_id,decision_id,proposal_field_values,created_at) values (r.test_run_id,r.release_id,r.intent_id,r.service_id,r.template_id,r.request_policy_id,r.conversation_id,r.session_id,r.topic_id,r.decision_id,r.proposal_field_values,r.created_at);
 return r;
end $$;
