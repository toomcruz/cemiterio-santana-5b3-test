...
Deno.test("rascunho, destino corrigido e documento recebido mantêm Exumação pendente sem repetir destino", async () => {
  ...
  const corrected = await handle(make("exu-pending", "d", "Na verdade quero levar para outro cemitério", "INDEFINIDO"), store);
  ...
  assertEquals(received.response.includes("responsável pela assinatura"), true);
