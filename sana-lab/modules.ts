...
export const MODULES = {
  EXUMACAO: {
    ...
    sources: ["santana-authority/catalogo/exumacao.v1.json"],
  ...
  RECADASTRO: {
    ...
    sources: ["santana-conversation-domain/goals.v1.json", "santana-conversation-domain/facts.v1.json",
      "santana-conversation-domain/questions.v1.json", "santana-conversation-domain/runtime/tests/official_journey_integration_test.ts",
