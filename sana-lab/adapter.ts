import { adaptLegacy, SCHEMA_VERSION, type Fact, type Input } from "./contracts.ts";
...
export function adaptN8nTurn(event: {
  ...
  return {
    ...
    document_references: event.document_references ?? [], case_facts: event.case_facts,
    linked_case_ids: event.linked_case_ids, interpretation,
  };
}
