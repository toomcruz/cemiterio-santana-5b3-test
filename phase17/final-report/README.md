...
- código usado para gerar o benchmark final: commit `4b81de5e7ea87a5981bad8a495171762ca90cb36`;
- evidência final: passe 8, com manifesto próprio e proveniência do commit-fonte;
...
- testes: 322/322 Deno no escopo domínio/benchmark, 25/25 no Authority Gateway e 13/13 Python/scorer.
...
- `benchmark/final-pass-8/`: engine runs e comparação oficial do passe final;
