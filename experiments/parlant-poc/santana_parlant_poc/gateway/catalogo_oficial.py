...
def catalogo_path() -> Path:
    ...
    # .../experiments/parlant-poc/santana_parlant_poc/gateway/catalogo_oficial.py
...
def carregar() -> CatalogoOficial:
    caminho = catalogo_path()
    if not caminho.exists():
        raise FileNotFoundError(f"Catalogo oficial nao encontrado: {caminho}")
